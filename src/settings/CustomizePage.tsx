...
export function CustomizePage() {
  ...
  return <main className="customize-page"><header><Palette size={22}/><div><h1>{tr('customization')}</h1><p>{tr('avatarIntro')}</p></div></header><div className="avatar-grid"><Card kind="userAvatar" label={tr('mine')} fallback="你" input={userInput}/><Card kind="assistantAvatar" label={tr('assistant')} fallback="C" input={assistantInput}/></div></main>;
}
